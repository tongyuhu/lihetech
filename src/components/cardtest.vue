<template>
  <div class="box">
    <transition name="outIn"  class="boxchild" ref="ref1">
      <!-- <transition-group tag="div" name="outIn" mode="out-in" class="boxchild"> -->
        <!-- <el-row v-for="(item,index) in items" :key="item.index" v-show="item.if"> -->

          <el-row v-for="(item,index) in items" :key="item.index" v-if="item.if" type="flex" justify="center">
                ...
                <el-col :span='24'>
                  <el-row>
                    ...
                    <el-row class="sick-card-center">
                      <el-col :span="1">
                        <el-button @click="pre(index)" icon="el-icon-arrow-left" type="text" class="arrow"></el-button>
                      </el-col>
                      <el-col :span="5" :offset="6">病历卡1</el-col> 
                      <el-col :span="11" >2014-8-9 星期5</el-col> 
                      <el-col :span="1">
                        <el-button @click="beh(index)" icon="el-icon-arrow-right" type="text" class="arrow"></el-button>
                      </el-col>
                    </el-row>
                  <!-- 病人表格信息 表头 end -->
                  <!-- 病历卡表格 -->
...
export default {
  ...
  methods: {
    pre (index) {
      // let aaa = document.getElementsByClassName('qqq')[0]
