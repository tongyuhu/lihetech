              ...
              <div class="flex">
                <div class="flex widthone">
                  ...
                  <div class="chart-min-width">
                    <div id='bloodAverageBar' :style="{width:'auto',height:'300px'}"></div>
                  </div>
                  <!-- 翻页按钮 -->
                  <div class="flex-btn">
...
import {dateFormat, computeMonthDays, computeWeekMorNoon} from '@/untils/date'
import {bloodAverageApi} from '@/api/components/BloodheighSickcard/bloodAverage'
export default {
  name: 'bloodAverageBar',
  props: {
    sickID: {
      default: 0
    },
  ...
  methods: {
    ...
    updatebloodTrendData (index, status) {
      ...
      let bloodTrend = echarts.init(document.getElementById('bloodAverageBar'))
      if (index === 0) {
